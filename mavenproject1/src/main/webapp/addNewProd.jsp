<%-- 
    Document   : addNewProd
    Created on : Apr 2, 2023, 10:04:58 PM
    Author     : pc
--%>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <h1>Please fill all the boxes!</h1>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">New Product</h5>
                     ...
                     <form class="row g-3" action="addingProdProcess.jsp" method="get">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="number" min="0" class="form-control" id="price" step="0.01" name="price" required>
                </div>
                <div class="col-md-4">
                  <label for="validationDefaultUsername" class="form-label">Description</label>
                  <div class="input-group">
<!--                    <span class="input-group-text" id="inputGroupPrepend2">@</span>-->
                    <input type="text" class="form-control" id="desc" name="desc" aria-describedby="inputGroupPrepend2" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <label for="validationDefault03" class="form-label">Rate</label>
                  <input type="number" max="5" min="0" class="form-control" id="rate" name="rate" required>
                </div>
                <div class="col-md-3">
                  <label for="validationDefault04" class="form-label">Category</label>
                  <select class="form-select" id="categ" name="categ" required>
