<%-- 
    ...
    Created on : Mar 28, 2023, 7:38:40 PM
    Author     : pc
--%>
...
String sql = new String("select * from prod");
            ...
            while(rs.next()){
             %>
                    <tbody>
<tr>
    <th scope="row"><img src="img/product-thumb-1.jpg" class="recent-thumb" alt="" width="30px" height="40px"></th>
                        ...
                        <td><%=rs.getInt(8) %></td>
                        <td>
                            <form action="deleteprod.jsp">
                                <input  type="hidden" id="pID" name="pID" value="<%=rs.getInt(1)%>">
            ...
            con.close();
             %>
<!--             <form action="addNewProd.jsp">
                 <input type="submit" value="Add new product">
             </form>-->
<button type="submit" class="btn btn-primary" onclick="location.href = 'addNewProd.jsp';">Add new product</button>
             <% 
