<%-- 
    Document   : editprod
    Created on : Apr 7, 2023, 5:05:11 PM
    Author     : pc
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <h1>Please fill boxes to be edited!</h1>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" action="editingProdProcess.jsp" method="get">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" min="0" class="form-control" id="price" step="0.01" name="price" >
                        </div>
                        <div class="col-md-4">
                            <label for="validationDefaultUsername" class="form-label">Description</label>
                            <div class="input-group">
                                <!--                    <span class="input-group-text" id="inputGroupPrepend2">@</span>-->
                                <input type="text" class="form-control" id="desc" name="desc" aria-describedby="inputGroupPrepend2" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="validationDefault03" class="form-label">Rate</label>
                            <input type="number" max="5" min="0" class="form-control" id="rate" name="rate" >
                        </div>
                        <div class="col-md-3">
