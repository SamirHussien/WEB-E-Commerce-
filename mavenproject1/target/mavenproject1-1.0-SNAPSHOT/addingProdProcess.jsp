<%-- 
    Document   : addingProdProcess
    Created on : Apr 2, 2023, 11:57:03 PM
    Author     : pc
--%>
...
//                      DriverManager.getConnection("jdbc:postgresql://127.0.0.1:5432/e-commerence",
//                              "postgres",
//                              "postgre");
      ...
      String sql = new String("insert into prod(prod_name, prod_price, prod_description, prod_type, prod_rate,prod_quantity) values ('"+prodname+"',"
      +price+",'"+descrip+"','"+category+"',"+rate+","+quantity+")");
           %>
                      <%
            ...
            if (r==1){
                    ...
                    <h2 style="color:green">Product inserted successfully</h2>
                    <%}
else{

%>
<h2 style="red">Problem happened! Please try again later</h2>
<%}%>
